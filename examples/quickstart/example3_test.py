...
from checkers.examples.quickstart import add_tests
from checkers.examples.quickstart import subtract_tests
...
def CreateTestRun():
  ...
  test_run.LoadTestsFromModule(add_tests)
  test_run.LoadTestsFromModule(subtract_tests)
  return test_run
